    ...
    const handleAssign = async () => {
      ...
      try {
        ...
        toast({
          ...
          description: `Ticket for ${ticket.subjectName} has been assigned and moved to In Progress.`,
        });
      ...
      <Dialog open={isOpen} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Select an analyst to assign to the ticket for "{ticket?.subjectName}". This will move the ticket to the "In Progress" queue.
            </DialogDescription>
          </DialogHeader>
            ...
            <Select onValueChange={setSelectedAnalystId} value={selectedAnalystId} disabled={isLoading}>
                ...
                <SelectContent>
                    {analysts.length > 0 ? analysts.map(analyst => (
                        ...
                        <SelectItem value="none" disabled>No analysts found. Please create an analyst user.</SelectItem>
                    )}
                </SelectContent>
            </Select>
          </div>
